...
<head>
	...
	<!--[if lte IE 7]><link href="<?=THEME_PATH;?>css/iehacks.css" rel="stylesheet" type="text/css" /><![endif]-->
	<script type="text/javascript" src="<?php echo THEME_PATH; ?>js/jquery.js"></script>
	<!--[if IE 6]>
	<script type="text/javascript" src="<?=THEME_PATH;?>js/ie6pngfix.js"></script>
...
<div class="rapidxwpr floatholder">
  <div class="rapidxwpr-bottom">
    ...
    <div id="header">
      ...
      <!-- logo -->
      <a href="index.html"><img id="logo" class="correct-png" src="<?=THEME_PATH;?>images/logo.png" alt="Home" title="Home" /></a>
      <!-- / logo -->
      
      <!-- quote -->
      <div class="quote">
        <img src="<?=THEME_PATH;?>images/quote.png" alt="Quote" />
      </div>
      <!-- / quote -->
      ...
      <div id="topmenu">
        <ul>
		<?=noodleTopMenu($config->nav1,'<li>','</li>');?>
		 <!--
